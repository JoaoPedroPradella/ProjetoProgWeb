...
<head>
    ...
    <link rel="stylesheet" href="..\..\assets\css\menu_api.css">
...
<main>
        ...
        <a href="saida\retorna_clientes.php?token=<?= $_SESSION['token']?>"><button>Consultar Clientes</button></a>
        ...
        <a href="saida\retorna_produtos.php?token=<?= $_SESSION['token']?>"><button>Consultar Produtos</button></a>
        ...
        <a href="saida\retorna_servicos.php?token=<?= $_SESSION['token']?>"><button>Consultar Serviços</button></a>
        ...
        <a href="saida\retorna_veiculos.php?token=<?= $_SESSION['token']?>"><button>Consultar Veículos</button></a>
        ...
        <a href="saida\retorna_vendedores.php?token=<?= $_SESSION['token']?>"><button>Consultar Vendedores</button></a>
        ...
        <a href="saida\retorna_categorias.php?token=<?= $_SESSION['token']?>"><button>Consultar Categorias</button></a>
        ...
        <a href="saida\retorna_vendas.php?token=<?= $_SESSION['token']?>"><button>Consultar Vendas</button></a>
    
        <a href="menu_consumo.php"><button>Consumir APIs</button></a>
</main>
